...
INSERT INTO products (category_id, name, product_type, unit_measure, purchase_price, sale_price, status) VALUES
  (1, 'Hamburguesa con papas + soda', 'producto para venta', 'unidad', 2.50, 6.00, 'active'),
  (1, 'Hot dog con papa + soda', 'producto para venta', 'unidad', 1.50, 4.00, 'active'),
  (1, 'Croissant con papas + soda', 'producto para venta', 'unidad', 2.50, 6.00, 'active'),
  (1, 'Torta', 'producto para venta', 'unidad', 1.80, 5.00, 'active'),
  (2, 'Tacos', 'producto para venta', 'unidad', 1.50, 5.00, 'active'),
  (2, 'Burritos', 'producto para venta', 'unidad', 1.50, 5.00, 'active'),
  (2, 'Quesadillas', 'producto para venta', 'unidad', 1.50, 5.00, 'active'),
  (3, 'Nuggets con papas + soda', 'producto para venta', 'unidad', 2.00, 5.00, 'active'),
  (3, 'Chunks con papas + soda', 'producto para venta', 'unidad', 2.00, 5.00, 'active'),
  (4, 'Sopa de tortilla', 'producto para venta', 'unidad', 1.50, 4.00, 'active'),
  (4, 'Asado de pollo', 'producto para venta', 'unidad', 2.00, 5.00, 'active'),
